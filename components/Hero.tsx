...
export default function Hero() {
  return (
    <section className="min-h-screen pt-32 flex flex-col justify-center items-center text-center px-6">
      ...
      <p className="text-gray-300 mt-6 max-w-2xl text-sm md:text-base">
      ...
      <div className="mt-8 flex gap-4">
        <a
          href="#contacto"
          className="bg-orange-500 text-black px-6 py-3 font-semibold rounded hover:bg-orange-400 transition"
        >
          Solicitar presupuesto sin cargo
        </a>
        <a
          href="#servicios"
          className="border border-orange-500 px-6 py-3 rounded hover:bg-orange-500 hover:text-black transition"
        >
          Ver servicios
        </a>
      </div>
